# (Unofficial) eBay API client (PHP) - Buy / Deal
...
Please refer to [eBay's documentation](https://developer.ebay.com/api-docs/buy/deal/overview.html) for detailed API behaviour explanation.
...
Starting from version 1.3.0, this project will match according eBay API's versioning. Should you found a matching 
